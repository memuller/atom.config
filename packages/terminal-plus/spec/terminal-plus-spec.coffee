...
describe "TerminalPlus", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('terminal-plus')

  describe "when the terminal-plus:toggle event is triggered", ->
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'terminal-plus:toggle'
        expect(terminalPlusElement).not.toBeVisible()
